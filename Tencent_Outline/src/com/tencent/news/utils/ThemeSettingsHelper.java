...
/**
 *夜间模式做了全局的管理,程序考虑到了通用性,若以后版本需本地换肤
 *功能可继续使用此类，只需进行简单扩展 
 * @author haiyandu
 */
public class ThemeSettingsHelper {
	...
	private ThemeSettingsHelper(Context context) {		
		initTheme(context, PreferenceManager.getDefaultSharedPreferences(
		context).getInt(Constants.SETTING_THEME,Constants.SETTING_THEME_DEFAULT_MODE));
	}
	...
	private Object getDefaultResourceValue(Context paramContext, int paramInt) {
		...
		return getResourceValue(localResources, paramInt, localResources
				.getResourceTypeName(paramInt));
	}

	/**
	 * @param paramResources res资源对象
	 * @param resourceId 资源Id
	 * @param resourceTypeName 资源类型
	 * @return 指定资源对象
	 */
	private Object getResourceValue(Resources paramResources, int resourceId,
	...
	private Context getThemeContext(Context context, int mThemePackageName) {
		ThemeSettingsHelper.mThemePackageName = mThemePackageName;
		Context localContext = null;
		if ((THEME_DEFAULT==mThemePackageName) || (THEME_NIGHT==mThemePackageName)){
	 ...
	 * @param paramContext
	 * @param paramString	 
	private void initTheme(Context context, String mThemePackageName) {
		this.mThemeContext = getThemeContext(context, mThemePackageName);
	}*/
	...
	public synchronized void changeTheme(Context context, int mThemePackageName) {
		...
		if(ThemeSettingsHelper.mThemePackageName!=mThemePackageName){
			PreferenceManager.getDefaultSharedPreferences(context).edit().putInt(Constants.SETTING_THEME,mThemePackageName).commit();
	...
	*/
	 ...
	 * @param paramThemeCallback 实现ThemeCallback接口的Activity
	 */
	 ...
	 * @param paramInt 要切换的资源id
	 */
	public void setImageViewSrc(Context context, ImageView imageView,
			int paramInt) {
		//添加
		if(imageView==null) {
			return;
	...
	public void setImageButtonSrc(Context context, ImageButton imageBtn,
			int paramInt) {
		//添加
		if(imageBtn==null) {
			return;
	 ...
	 * @param paramInt
	 */
	public void setListViewDivider(Context context,
			ListView listView, int paramInt) {
		if(listView==null) {
			return;
		}
	 ...
	 * @param paramInt
	 */
	public void setListViewSelector(Context context,
			ListView listView, int paramInt) {
		if(listView==null) {
			return;
		}
	 ...
	 * @param paramInt
	 */
	public void setListViewCacheColorHit(Context paramContext, ListView paramTextView,
			int paramInt) {
	 ...
	 * @param paramInt
	 */
	public void setTextViewColor(Context paramContext, TextView paramTextView,
			int paramInt) {
		if(paramTextView==null) {
			return;
		}
	 ...
	 * @param paramInt
	 */
	public void setViewBackgroud(Context paramContext, View view,
			int paramInt) {
		if(view==null) {
			return;
		}
	 ...
	 * @param paramInt
	 */
	public void setViewBackgroudColor(Context paramContext, View paramView,
			int paramInt) {
		if(paramView==null) {
			return;
		}
	 ...
	 * @param paramInt
	 */
	public void setCheckBoxBackgroud(Context paramContext, CheckBox paramView,
			int paramInt) {
		if(paramView==null) {
			return;
		}
	 ...
	 * @param paramInt
	 */
	public void setPopupWindowBackgroud(Context paramContext, PopupWindow paramView,
			int paramInt) {
		if(paramView==null) {
			return;
		}
	 ...
	 * @param paramInt
	 */
	public void setEditTextHitColor(Context paramContext, TextView paramView,
			int paramInt) {
		if(paramView==null) {
			return;
		}
	...
	public void setWindowBackgroud(Activity paramActivity, int paramInt) {
		paramActivity.getWindow().setBackgroundDrawable(
				getThemeDrawable(paramActivity, paramInt));
	}
	...
	public void setViewPagerMargin(Context paramContext, ViewPager paramView,
			int paramInt){
		if(paramView==null) {
			return;
		}
