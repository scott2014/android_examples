...
public class DownloadAPNUtil {
	...
	public static String getApnProxyIp(Context context) {
		byte apnType = DownloadAPNUtil.getApnType(context);
		if (apnType==DownloadAPNUtil.APNTYPE_CMWAP||apnType==DownloadAPNUtil.APNTYPE_UNIWAP||apnType==DownloadAPNUtil.APNTYPE_3GWAP)
			return "10.0.0.172";
		
		if (apnType==DownloadAPNUtil.APNTYPE_CTWAP) 
			return "10.0.0.200";
